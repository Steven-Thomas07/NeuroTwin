...
# Add paths
sys.path.insert(0, os.path.dirname(__file__))  # Add current directory for brain.renderer
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'NeuroTwin'))  # Add NeuroTwin for twin.builder
